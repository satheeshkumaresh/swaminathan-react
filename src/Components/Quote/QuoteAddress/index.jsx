...
import {customerEstimateShippingById} from "../../Checkout/Customercheckout/APIList";
...
const Index = ({
  ...
  shippingInformtionData, setIsValidShippingAddress, setIsShippingAddressChnaged,userdata
}) => {
  console.log("isExist userdata in quoteadd",userdata);
  ...
  useEffect(() => {
    if (Object.keys(userdata).length) {
      setShippingFormValues(prevState => ({
        ...
        mobile_valid:userdata?.mobile
      }));
    }
  }, [userdata, setShippingFormValues]);
  // console.log("133num",shippingFormValues.number);
  // console.log("133numm",shippingFormValues.mobile_valid);
  return (
    <Stack className='shipping-address-block' style={{padding: '0px'}}>
      <Stack className='shipping-address-section-form'>
      <Typography className='summary-title' style={{ textAlign : 'left'}}>Enter your details</Typography>
      </Stack>
      {
        !getShippingBillingAddres?.data?.all_address?.length
          ...
          <Stack className='shipping-address-form-block-section'>
            ...
            <Box className='input-block-section fullwidth'>
                <Typography className="input_label" style={{ textAlign : 'left' , marginTop: '10px'}}>First Name<Typography variant='span'>*</Typography></Typography>
                <Stack className='form-address-form common_input_block_section'>
                  <TextField
                    ...
                    value={Object.keys(userdata).length?userdata.firstname: shippingFormValues?.first_name}
                  ...
                  />
                  {
                    formErrorShipping?.first_name && <Typography className='form-error-lable field-error'  style={{textAlign : 'left'}}>{formErrorShipping?.first_name}</Typography>
                  }
                </Stack>
            ...
            <Stack className='form-block address-section-form fullwidth'>
            <Box className='input-block-section fullwidth'>
                <Typography className="input_label" style={{ textAlign : 'left' , marginTop: '10px'}}>Last Name<Typography variant='span'>*</Typography></Typography>
                <Stack className='form-address-form common_input_block_section'>
                  ...
                  <TextField className='input-text common_input_block_section'
                    ...
                    id='last_name'
                    disabled={Object.keys(userdata).length?true:false}
                    value={Object.keys(userdata).length ?userdata.lastname:shippingFormValues?.last_name}
                  ...
                  />
                  {
                    formErrorShipping?.last_name && <Typography className='form-error-lable field-error' style={{textAlign : 'left'}}>{formErrorShipping?.last_name}</Typography>
                  }
                </Stack>
            ...
            <Stack className='form-block address-section-form fullwidth'>
              <Box className={`input-block-section phone-section ${formErrorShipping?.number ? 'show_error' : ''}`}>
                <Typography className="input_label " style={{ textAlign : 'left' , marginTop: '10px'}}>Phone Number<Typography variant='span'>*</Typography></Typography>
                <Stack className='form-address-form common_input_block_section'>
                  <PhoneInput
                    country={'in'}
                    id="number"
                  ...
                  />
                  {
                    formErrorShipping?.number && <Typography className='form-error-lable field-error' style={{ marginTop: "10px", textAlign : 'left'}}>{formErrorShipping?.number}</Typography>
                  }
                </Stack>
              </Box>
            </Stack>
